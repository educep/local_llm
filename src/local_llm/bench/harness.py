"""Benchmark harness — runs prompts across engines × models and records metrics.

STATUS: Phase 4 stub. Will:
  1. Load each runner × model combination requested on the CLI.
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--all", action="store_true", help="Run every engine × every known model")
